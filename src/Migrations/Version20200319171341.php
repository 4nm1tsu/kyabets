 ...
 */
final class Version20200319171341 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE archive (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, archive_name VARCHAR(255) NOT NULL, archive_title VARCHAR(255) NOT NULL, archive_size INTEGER NOT NULL, updated_at DATETIME NOT NULL)');
        $this->addSql('
