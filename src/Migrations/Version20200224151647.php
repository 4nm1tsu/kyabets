 ...
 */
final class Version20200224151647 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__bbs AS SELECT id, user_id, contents, date, type FROM bbs');
        $this->addSql('DROP TABLE bbs');
        $this->addSql('CREATE TABLE bbs (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER NOT NULL, contents VARCHAR(1023) NOT NULL COLLATE BINARY, date DATETIME NOT NULL, type VARCHAR(255) NOT NULL COLLATE BINARY, CONSTRAINT FK_2AD5EFFFA76ED395 FOREIGN KEY (user_id) REFERENCES user (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO bbs (id, user_id, contents, date, type) SELECT id, user_id, contents, date, type FROM __temp__bbs');
